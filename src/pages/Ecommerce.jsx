      ...
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
         ...
         w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$54,455.54</p>
            </div>
          </div>
           <div className='mt-6'>
         ...
         <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
            {earningData.map((item) => (
              <div key={item.title} className='bg-white dark:tex-gray-200 dark:bg-secondary-dark-bg
              md:w-56 p-4 pt-9 rounded-2xl'>
                  <button type='button' style={{ color: item.iconColor,
                  backgroundColor: item.iconBg }} className='text-2xl
                  opacity-0.9 rounded-full p-4 hover:drop-shadow-xl'>
                    {item.icon}
                  </button>
                    <p className='mt-3'>
            ...
            <div className='flex gaap-10 flex-wrap justify-center'>
            ...
            dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
                ...
                <div className='mt-10 flex gap-10 flex-wrap justify-center'>
                    <div className='border-r-1 border-color m-4 pr-10'>
                      <div>
                        <p>
                          <span className='text-3xl font-semibold'>$93,354</span>
                      ...
                      <div className='mt-8'>
                        <p>
                          <span className='text-3xl font-semibold'>$48,354</span>
